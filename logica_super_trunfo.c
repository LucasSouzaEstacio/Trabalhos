...
int main(){
    ...
    if(atributo2 == 5){ //densidade (menor vence)
        resultado2 = (v1_attr2 < v2_attr2) ? 1 : (v2_attr2 < v1_attr2 ? 2 : 0);
    } else {
        resultado2 = (v1_attr2 > v2_attr2) ? 1 : (v2_attr2 > v1_attr2 ? 2 : 0);
    }
    ...
    printf("Atributo 1 escolhido: %d -> Carta 1: %.2f | Carta 2: %.2f | Vencedor: %s\n",
           atributo1, v1_attr1, v2_attr1, resultado1==1 ? "Carta 1" : resultado1==2 ? "Carta 2" : "Empate");

    printf("Atributo 2 escolhido: %d -> Carta 1: %.2f | Carta 2: %.2f | Vencedor: %s\n",
           atributo2, v1_attr2, v2_attr2, resultado2==1 ? "Carta 1" : resultado2==2 ? "Carta 2" : "Empate");

    printf("\nSoma dos atributos: Carta 1 = %.2f | Carta 2 = %.2f\n", soma1, soma2);
    printf("Resultado Final: %s\n", resultadoFinal==1 ? "Carta 1 venceu!" : resultadoFinal==2 ? "Carta 2 venceu!" : "Empate!");
